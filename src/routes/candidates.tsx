      ...
      <div className="page-wrap">
        ...
        <details className="mt-3 text-sm">
          ...
          <div className="mt-3 max-w-4xl space-y-2 border-l-2 border-border pl-4 text-sm leading-6 text-muted-foreground">
            ...
            <p><strong className="text-foreground">Coding reliability:</strong> A separate coding pass showed 88.4% agreement with the primary coding (Cohen's κ = 0.77). Differences were manually reviewed against the candidates' verbatim responses before final categories were assigned.</p>
          </div>
        </details>
      </div>
    </section>
