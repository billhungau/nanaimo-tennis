  ...
  return <>
    ...
    <section className="border-y border-border bg-secondary/50 py-10 sm:py-12">
      <div className="page-wrap flex flex-col justify-between gap-5 md:flex-row md:items-center">
        <div><p className="eyebrow">2026 municipal election</p><h2 className="mt-2 font-serif text-2xl sm:text-3xl">Read candidates' positions in their own words.</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">Every mayoral and council candidate is being asked the same questions. Responses are published without endorsement or ranking.</p></div>
        <Button asChild variant="outline" className="w-fit shrink-0"><Link to="/candidates">See candidate positions<ArrowRight /></Link></Button>
      </div>
    </section>
